...
Este proyecto ya tiene habilitados distintos workflows de integración continua para compilar y probar de forma automática su aplicación. Puede borrar los flujos de trabajo que no necesite y dejar solo el que aplica a la tecnología que esta usando.

1. [android.yml](.github/workflows/android.yml): este flujo de trabajo compila su app desarrollada con Kotlin, guarda la version del APK generado, y lo envía a Firebase Test Lab para que se pruebe de forma automática.

1. [flutter.yml](.github/workflows/flutter.yml): este flujo de trabajo compila su app desarrollada con Flutter, guarda la version del APK generado, y lo envía a Firebase Test Lab para que se pruebe de forma automática.

1. [unity.yml](.github/workflows/unity.yml): este flujo de trabajo compila una app generada con Unity, guarda la version del APK generado, y lo envía a FIrebase Test Lab para que se pruebe de forma automática.
