...
This repository contains the source code and documentation for a project built with React Native and Expo
...
- Continuous integration workflow: the [`react-native.yml`](.github/workflows/react-native.yml) file show how to achieve continuous integration for this project. You can copy this file in your own project.
